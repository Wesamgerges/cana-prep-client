...
export default function (ctx, inject) {
  ...
  // facebook
  $auth.registerStrategy('facebook', new scheme_23514a38($auth, {"client_id":"","userinfo_endpoint":false,"scope":["public_profile","email"],"redirect_uri":"http://localhost:3000/callback","_name":"facebook","authorization_endpoint":"https://facebook.com/v2.12/dialog/oauth"}))
